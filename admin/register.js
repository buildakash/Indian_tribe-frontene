...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      const response = await fetch("http://localhost/Indian%20Tribe/Backend_php/routes/admin/register_admin.php", {
        method: "POST",
        body: formData
      });
      ...
      if (error.name === 'TypeError' && error.message.includes('fetch')) {
        ...
        showToast('❌ Registration service not found. Please contact administrator.', 'error');
